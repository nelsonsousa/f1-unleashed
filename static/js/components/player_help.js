 ...
 *
 * A "Help" link on the right of the status footer opens this overlay, which
 * explains every playback control. It is deliberately a client-only overlay:
 * opening it does NOT pause playback, so the help stays readable while the
 * session keeps running underneath. Built on demand, mirroring settings.js.
 */
(function () {
    'use strict';
    ...
    function ensureModal() {
        ...
        m.innerHTML =
            `<div class="phelp-dialog" role="dialog" aria-modal="false" aria-label="Help">
                <div class="phelp-head"><h3>Help</h3><button class="phelp-close" aria-label="Close">&times;</button></div>
